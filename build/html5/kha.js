...
var AnimationKha = function() {
	this.speed = 100;
	this.time = 0;
	this.lines = [];
	this.currentColor = target__$BasicColors_BasicColors_$Impl_$.Red;
	this.colors = [target__$BasicColors_BasicColors_$Impl_$.Red,target__$BasicColors_BasicColors_$Impl_$.Green,target__$BasicColors_BasicColors_$Impl_$.Blue,target__$BasicColors_BasicColors_$Impl_$.Red,target__$BasicColors_BasicColors_$Impl_$.Green,target__$BasicColors_BasicColors_$Impl_$.Green,target__$BasicColors_BasicColors_$Impl_$.Red,target__$BasicColors_BasicColors_$Impl_$.Green,target__$BasicColors_BasicColors_$Impl_$.Yellow,target__$BasicColors_BasicColors_$Impl_$.Red,target__$BasicColors_BasicColors_$Impl_$.Grey];
	var pos = new khaMath_Vector2(700,600);
	var this1;
	var options = { axiom : "A"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("A","B-A-B");
	lsystem1.setRule("B","A+B+A");
	lsystem1.iterate(7);
	var angle = 270.0;
	var d = 4.5;
	var line = $bind(this,this.line);
	this1 = new drawings_Drawing(lsystem1,pos,angle);
	this1.render = function(charCode) {
		...
		case 65:case 66:
			...
			var tmp = new lsystem_TwoNodes(currentState,newState);
			line(tmp);
			break;
		case 91:
			var currentState1 = s[s.length - 1];
			s[s.length] = currentState1.clone();
			break;
		case 93:
			s.pop();
			break;
	...
	var tmp1 = this1;
	var pos1 = new khaMath_Vector2(100,600);
	var this2;
	var options1 = { axiom : "W"};
	var lsystem2 = new lsystem_LSystem(options1);
	lsystem2.setRule("W","+++X--F--ZFX+");
	lsystem2.setRule("X","---W++F++YFW-");
	lsystem2.setRule("Y","+ZFX--F--Z+++");
	lsystem2.setRule("Z","-YFW++F++Y---");
	lsystem2.iterate(6);
	var angle1 = 270.0;
	var d1 = 10;
	var line1 = $bind(this,this.line);
	this2 = new drawings_Drawing(lsystem2,pos1,angle1);
	this2.render = function(charCode1) {
		var s1 = this2.stack;
		switch(charCode1) {
		case 43:
			s1[s1.length - 1].addAngle(30.0);
			break;
		case 45:
			s1[s1.length - 1].addAngle(-30.0);
			break;
		case 70:case 87:case 88:case 89:case 90:
			var currentState2 = s1[s1.length - 1];
			var newState1 = currentState2.transform(d1);
			s1[s1.length - 1] = newState1;
			var tmp2 = new lsystem_TwoNodes(currentState2,newState1);
			line1(tmp2);
			break;
		case 91:
			var currentState3 = s1[s1.length - 1];
			s1[s1.length] = currentState3.clone();
			break;
		case 93:
			s1.pop();
			break;
	...
	var tmp3 = this2;
	var pos2 = new khaMath_Vector2(512.,384.);
	var this3;
	var options2 = { axiom : "[7]++[7]++[7]++[7]++[7]"};
	var lsystem3 = new lsystem_LSystem(options2);
	lsystem3.setRule("6","81++91----71[-81----61]++");
	lsystem3.setRule("7","+81--91[---61--71]+");
	lsystem3.setRule("8","-61++71[+++81++91]-");
	lsystem3.setRule("9","--81++++61[+91++++71]--71");
	lsystem3.setRule("1","");
	lsystem3.iterate(5);
	var angle2 = 270.0;
	var d2 = 20;
	var line2 = $bind(this,this.line);
	this3 = new drawings_Drawing(lsystem3,pos2,angle2);
	this3.render = function(charCode2) {
		var s2 = this3.stack;
		switch(charCode2) {
		case 43:
			s2[s2.length - 1].addAngle(36.0);
			break;
		case 45:
			s2[s2.length - 1].addAngle(-36.0);
			break;
		case 49:case 54:case 55:case 56:case 57:
			var currentState4 = s2[s2.length - 1];
			var newState2 = currentState4.transform(d2);
			s2[s2.length - 1] = newState2;
			var tmp4 = new lsystem_TwoNodes(currentState4,newState2);
			line2(tmp4);
			break;
		case 91:
			var currentState5 = s2[s2.length - 1];
			s2[s2.length] = currentState5.clone();
			break;
		case 93:
			s2.pop();
			break;
	...
	var tmp5 = this3;
	var pos3 = new khaMath_Vector2(550,600);
	var this4;
	var green = target__$BasicColors_BasicColors_$Impl_$.Green;
	var blue = target__$BasicColors_BasicColors_$Impl_$.Blue;
	var red = target__$BasicColors_BasicColors_$Impl_$.Red;
	var options3 = { axiom : "F"};
	var lsystem4 = new lsystem_LSystem(options3);
	lsystem4.setRule("F","AFF[B-F++F][C+F--F]C++F--F");
	lsystem4.iterate(5);
	var angle3 = 180.0;
	var d3 = 1;
	var line3 = $bind(this,this.line);
	var f = $bind(this,this.setColor);
	var color = function(a2) {
		f(3,a2);
	};
	this4 = new drawings_Drawing(lsystem4,pos3,angle3);
	this4.render = function(charCode3) {
		var s3 = this4.stack;
		switch(charCode3) {
		case 43:
			s3[s3.length - 1].addAngle(27.0);
			break;
		case 45:
			s3[s3.length - 1].addAngle(-27.0);
			break;
		...
		case 67:
			...
			break;
		case 70:
			var currentState6 = s3[s3.length - 1];
			var newState3 = currentState6.transform(d3);
			s3[s3.length - 1] = newState3;
			var tmp6 = new lsystem_TwoNodes(currentState6,newState3);
			line3(tmp6);
			break;
		case 91:
			var currentState7 = s3[s3.length - 1];
			s3[s3.length] = currentState7.clone();
			break;
		case 93:
			s3.pop();
			break;
	...
	var tmp7 = this4;
	var pos4 = new khaMath_Vector2(750,600);
	var this5;
	var green1 = target__$BasicColors_BasicColors_$Impl_$.Green;
	var blue1 = target__$BasicColors_BasicColors_$Impl_$.Blue;
	var red1 = target__$BasicColors_BasicColors_$Impl_$.Red;
	var options4 = { axiom : "F"};
	var lsystem5 = new lsystem_LSystem(options4);
	lsystem5.setRule("F","AFF-[B-F+F+F]+[C+F-F-F]");
	lsystem5.iterate(5);
	var angle4 = 270.0;
	var d4 = 5;
	var line4 = $bind(this,this.line);
	var f1 = $bind(this,this.setColor);
	var color1 = function(a21) {
		f1(4,a21);
	};
	this5 = new drawings_Drawing(lsystem5,pos4,angle4);
	this5.render = function(charCode4) {
		var s4 = this5.stack;
		switch(charCode4) {
		case 43:
			s4[s4.length - 1].addAngle(22.0);
			break;
		case 45:
			s4[s4.length - 1].addAngle(-22.0);
			break;
		...
		case 67:
			...
			break;
		case 70:
			var currentState8 = s4[s4.length - 1];
			var newState4 = currentState8.transform(d4);
			s4[s4.length - 1] = newState4;
			var tmp8 = new lsystem_TwoNodes(currentState8,newState4);
			line4(tmp8);
			break;
		case 91:
			var currentState9 = s4[s4.length - 1];
			s4[s4.length] = currentState9.clone();
			break;
		case 93:
			s4.pop();
			break;
	...
	var tmp9 = this5;
	var pos5 = new khaMath_Vector2(500,200);
	var this6;
	var options5 = { axiom : "F++F++F"};
	var lsystem6 = new lsystem_LSystem(options5);
	lsystem6.setRule("F","F-F++F-F");
	lsystem6.setRule("X","FF");
	lsystem6.iterate(4);
	var angle5 = 270.0;
	var d5 = 2;
	var line5 = $bind(this,this.line);
	this6 = new drawings_Drawing(lsystem6,pos5,angle5);
	this6.render = function(charCode5) {
		var s5 = this6.stack;
		switch(charCode5) {
		case 43:
			s5[s5.length - 1].addAngle(60.0);
			break;
		case 45:
			s5[s5.length - 1].addAngle(-60.0);
			break;
		case 70:case 88:
			var currentState10 = s5[s5.length - 1];
			var newState5 = currentState10.transform(d5);
			s5[s5.length - 1] = newState5;
			var tmp10 = new lsystem_TwoNodes(currentState10,newState5);
			line5(tmp10);
			break;
		case 91:
			var currentState11 = s5[s5.length - 1];
			s5[s5.length] = currentState11.clone();
			break;
		case 93:
			s5.pop();
			break;
	...
	var tmp11 = this6;
	var pos6 = new khaMath_Vector2(90,600);
	var this7;
	var options6 = { axiom : "A"};
	var lsystem7 = new lsystem_LSystem(options6);
	lsystem7.setRule("A","B-[[A]+A]+B[+BA]-A");
	lsystem7.setRule("B","BB");
	lsystem7.iterate(4);
	var angle6 = 270.0;
	var d6 = 4;
	var line6 = $bind(this,this.line);
	this7 = new drawings_Drawing(lsystem7,pos6,angle6);
	this7.render = function(charCode6) {
		var s6 = this7.stack;
		switch(charCode6) {
		case 43:
			s6[s6.length - 1].addAngle(25.0);
			break;
		case 45:
			s6[s6.length - 1].addAngle(-25.0);
			break;
		case 65:case 66:
			var currentState12 = s6[s6.length - 1];
			var newState6 = currentState12.transform(d6);
			s6[s6.length - 1] = newState6;
			var tmp12 = new lsystem_TwoNodes(currentState12,newState6);
			line6(tmp12);
			break;
		case 91:
			var currentState13 = s6[s6.length - 1];
			s6[s6.length] = currentState13.clone();
			break;
		case 93:
			s6.pop();
			break;
	...
	var tmp13 = this7;
	var pos7 = new khaMath_Vector2(800,300);
	var this8;
	var options7 = { axiom : "X"};
	var lsystem8 = new lsystem_LSystem(options7);
	lsystem8.setRule("X","F[+X][-X]FX");
	lsystem8.setRule("F","FF");
	lsystem8.iterate(7);
	var angle7 = 270.0;
	var d7 = 1;
	var line7 = $bind(this,this.line);
	this8 = new drawings_Drawing(lsystem8,pos7,angle7);
	this8.render = function(charCode7) {
		var s7 = this8.stack;
		switch(charCode7) {
		case 43:
			s7[s7.length - 1].addAngle(27.5);
			break;
		case 45:
			s7[s7.length - 1].addAngle(-27.5);
			break;
		case 70:case 88:
			var currentState14 = s7[s7.length - 1];
			var newState7 = currentState14.transform(d7);
			s7[s7.length - 1] = newState7;
			var tmp14 = new lsystem_TwoNodes(currentState14,newState7);
			line7(tmp14);
			break;
		case 91:
			var currentState15 = s7[s7.length - 1];
			s7[s7.length] = currentState15.clone();
			break;
		case 93:
			s7.pop();
			break;
	...
	var tmp15 = this8;
	var pos8 = new khaMath_Vector2(400,400);
	var this9;
	var options8 = { axiom : "X"};
	var lsystem9 = new lsystem_LSystem(options8);
	lsystem9.setRule("X","F[+X]F[-X]+X");
	lsystem9.setRule("F","FF");
	lsystem9.iterate(7);
	var angle8 = 270.0;
	var d8 = 1;
	var line8 = $bind(this,this.line);
	this9 = new drawings_Drawing(lsystem9,pos8,angle8);
	this9.render = function(charCode8) {
		var s8 = this9.stack;
		switch(charCode8) {
		case 43:
			s8[s8.length - 1].addAngle(20.);
			break;
		case 45:
			s8[s8.length - 1].addAngle(-20.);
			break;
		case 70:case 88:
			var currentState16 = s8[s8.length - 1];
			var newState8 = currentState16.transform(d8);
			s8[s8.length - 1] = newState8;
			var tmp16 = new lsystem_TwoNodes(currentState16,newState8);
			line8(tmp16);
			break;
		case 91:
			var currentState17 = s8[s8.length - 1];
			s8[s8.length] = currentState17.clone();
			break;
		case 93:
			s8.pop();
			break;
	...
	var tmp17 = this9;
	var pos9 = new khaMath_Vector2(80,170);
	var this10;
	var options9 = { axiom : "FX"};
	var lsystem10 = new lsystem_LSystem(options9);
	lsystem10.setRule("X","X+YF");
	lsystem10.setRule("Y","FX-Y");
	lsystem10.iterate(10);
	var angle9 = 270.0;
	var d9 = 10;
	var line9 = $bind(this,this.line);
	this10 = new drawings_Drawing(lsystem10,pos9,angle9);
	this10.render = function(charCode9) {
		var s9 = this10.stack;
		switch(charCode9) {
		case 43:
			s9[s9.length - 1].addAngle(90.0);
			break;
		case 45:
			s9[s9.length - 1].addAngle(-90.0);
			break;
		case 70:
			var currentState18 = s9[s9.length - 1];
			var newState9 = currentState18.transform(d9);
			s9[s9.length - 1] = newState9;
			var tmp18 = new lsystem_TwoNodes(currentState18,newState9);
			line9(tmp18);
			break;
		case 91:
			var currentState19 = s9[s9.length - 1];
			s9[s9.length] = currentState19.clone();
			break;
		case 93:
			s9.pop();
			break;
	...
	var tmp19 = this10;
	var pos10 = new khaMath_Vector2(974,718);
	var this11;
	var options10 = { axiom : "A"};
	var lsystem11 = new lsystem_LSystem(options10);
	lsystem11.setRule("A","B-A-B");
	lsystem11.setRule("B","A+B+A");
	lsystem11.iterate(8);
	var angle10 = 180.0;
	var d10 = 2;
	var line10 = $bind(this,this.line);
	this11 = new drawings_Drawing(lsystem11,pos10,angle10);
	this11.render = function(charCode10) {
		var s10 = this11.stack;
		switch(charCode10) {
		case 43:
			s10[s10.length - 1].addAngle(60.0);
			break;
		case 45:
			s10[s10.length - 1].addAngle(-60.0);
			break;
		case 65:case 66:
			var currentState20 = s10[s10.length - 1];
			var newState10 = currentState20.transform(d10);
			s10[s10.length - 1] = newState10;
			var tmp20 = new lsystem_TwoNodes(currentState20,newState10);
			line10(tmp20);
			break;
		case 91:
			var currentState21 = s10[s10.length - 1];
			s10[s10.length] = currentState21.clone();
			break;
		case 93:
			s10.pop();
			break;
	...
	this.drawings = [tmp1,tmp3,tmp5,tmp7,tmp9,tmp11,tmp13,tmp15,tmp17,tmp19,this11];
	kha_System.notifyOnRender($bind(this,this.render));
	kha_Scheduler.addTimeTask($bind(this,this.update),0,0.0166666666666666664);
};
$hxClasses["AnimationKha"] = AnimationKha;
AnimationKha.__name__ = true;
AnimationKha.prototype = {
	currentColor: null
	,lines: null
	,drawing: null
	,drawings: null
	,colors: null
	,setColor: function(count,col) {
		this.colors[count] = col;
	}
	,clear: function() {
		var aline;
		while(true) {
			aline = this.lines.pop();
			if(!(aline != null)) {
				break;
			}
		}
	...
	,position: function(x,y) {
		return new khaMath_Vector2(x,y);
	}
	,centre: function() {
		return new khaMath_Vector2(512.,384.);
	}
	,bottomRight: function() {
		return new khaMath_Vector2(974,718);
	}
	,topLeft: function() {
		return new khaMath_Vector2(80,170);
	}
	,line: function(line) {
		var start = line.start;
		var end = line.end;
		var aline = { x0 : start.pos.x, y0 : start.pos.y, x1 : end.pos.x, y1 : end.pos.y, col : this.currentColor};
		this.lines[this.lines.length] = aline;
	}
	,time: null
	,speed: null
	,update: function() {
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "AnimationKha", width : 1024, height : 768},function() {
		new AnimationKha();
	});
};
Math.__name__ = true;
...
var drawings__$DragonCurve_DragonCurve_$Impl_$ = {};
$hxClasses["drawings._DragonCurve.DragonCurve_Impl_"] = drawings__$DragonCurve_DragonCurve_$Impl_$;
drawings__$DragonCurve_DragonCurve_$Impl_$.__name__ = true;
drawings__$DragonCurve_DragonCurve_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "FX"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("X","X+YF");
	lsystem1.setRule("Y","FX-Y");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
	var line = lineFunc;
	this1 = new drawings_Drawing(lsystem1,pos,angle);
...
var drawings_Drawing = function(lsystem1,pos,angle) {
	var node = new lsystem_LNode(pos,angle);
	var this1 = [];
	this1[0] = node;
	this.stack = this1;
	this.axiom = lsystem1.get_options().axiom;
	haxe_Log.trace("axiom " + this.axiom,{ fileName : "Drawing.hx", lineNumber : 16, className : "drawings.Drawing", methodName : "new"});
	this.length = this.axiom.length;
	this.count = 0;
};
$hxClasses["drawings.Drawing"] = drawings_Drawing;
drawings_Drawing.__name__ = true;
drawings_Drawing.prototype = {
	stack: null
	,axiom: null
	,length: null
	,count: null
	...
	,next: function() {
		return this.axiom.charCodeAt(this.count++);
	}
	,draw: function() {
		if(this.render != null) {
			this.render(this.axiom.charCodeAt(this.count++));
		}
	}
	,__class__: drawings_Drawing
};
var drawings__$FunnyTriangle_FunnyTriangle_$Impl_$ = {};
$hxClasses["drawings._FunnyTriangle.FunnyTriangle_Impl_"] = drawings__$FunnyTriangle_FunnyTriangle_$Impl_$;
drawings__$FunnyTriangle_FunnyTriangle_$Impl_$.__name__ = true;
drawings__$FunnyTriangle_FunnyTriangle_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "W"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("W","+++X--F--ZFX+");
	lsystem1.setRule("X","---W++F++YFW-");
	lsystem1.setRule("Y","+ZFX--F--Z+++");
	lsystem1.setRule("Z","-YFW++F++Y---");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
	var line = lineFunc;
...
var drawings__$PenoTriangle_PenoTriangle_$Impl_$ = {};
$hxClasses["drawings._PenoTriangle.PenoTriangle_Impl_"] = drawings__$PenoTriangle_PenoTriangle_$Impl_$;
drawings__$PenoTriangle_PenoTriangle_$Impl_$.__name__ = true;
drawings__$PenoTriangle_PenoTriangle_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "A"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("A","B-A-B");
...
var drawings__$Plant_Plant_$Impl_$ = {};
$hxClasses["drawings._Plant.Plant_Impl_"] = drawings__$Plant_Plant_$Impl_$;
drawings__$Plant_Plant_$Impl_$.__name__ = true;
drawings__$Plant_Plant_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "A"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("A","B-[[A]+A]+B[+BA]-A");
	lsystem1.setRule("B","BB");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
	var line = lineFunc;
...
var drawings__$PlantD_PlantD_$Impl_$ = {};
$hxClasses["drawings._PlantD.PlantD_Impl_"] = drawings__$PlantD_PlantD_$Impl_$;
drawings__$PlantD_PlantD_$Impl_$.__name__ = true;
drawings__$PlantD_PlantD_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "X"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("X","F[+X]F[-X]+X");
	lsystem1.setRule("F","FF");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
	var line = lineFunc;
...
var drawings__$PlantE_PlantE_$Impl_$ = {};
$hxClasses["drawings._PlantE.PlantE_Impl_"] = drawings__$PlantE_PlantE_$Impl_$;
drawings__$PlantE_PlantE_$Impl_$.__name__ = true;
drawings__$PlantE_PlantE_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "X"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("X","F[+X][-X]FX");
	lsystem1.setRule("F","FF");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
...
var drawings__$PondWeed_PondWeed_$Impl_$ = {};
$hxClasses["drawings._PondWeed.PondWeed_Impl_"] = drawings__$PondWeed_PondWeed_$Impl_$;
drawings__$PondWeed_PondWeed_$Impl_$.__name__ = true;
drawings__$PondWeed_PondWeed_$Impl_$._new = function(iterations,distance,pos,lineFunc,colorFunc) {
	var this1;
	var green = target__$BasicColors_BasicColors_$Impl_$.Green;
	var blue = target__$BasicColors_BasicColors_$Impl_$.Blue;
	var red = target__$BasicColors_BasicColors_$Impl_$.Red;
	var options = { axiom : "F"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("F","AFF-[B-F+F+F]+[C+F-F-F]");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
	var line = lineFunc;
...
var drawings__$Seaweed_Seaweed_$Impl_$ = {};
$hxClasses["drawings._Seaweed.Seaweed_Impl_"] = drawings__$Seaweed_Seaweed_$Impl_$;
drawings__$Seaweed_Seaweed_$Impl_$.__name__ = true;
drawings__$Seaweed_Seaweed_$Impl_$._new = function(iterations,distance,pos,lineFunc,colorFunc) {
	var this1;
	var green = target__$BasicColors_BasicColors_$Impl_$.Green;
	var blue = target__$BasicColors_BasicColors_$Impl_$.Blue;
	var red = target__$BasicColors_BasicColors_$Impl_$.Red;
	var options = { axiom : "F"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("F","AFF[B-F++F][C+F--F]C++F--F");
	lsystem1.iterate(iterations);
	var angle = 180.0;
	var d = distance;
	var line = lineFunc;
...
var drawings__$SierpinskiSnowFlake_SierpinskiSnowFlake_$Impl_$ = {};
$hxClasses["drawings._SierpinskiSnowFlake.SierpinskiSnowFlake_Impl_"] = drawings__$SierpinskiSnowFlake_SierpinskiSnowFlake_$Impl_$;
drawings__$SierpinskiSnowFlake_SierpinskiSnowFlake_$Impl_$.__name__ = true;
drawings__$SierpinskiSnowFlake_SierpinskiSnowFlake_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "F++F++F"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("F","F-F++F-F");
	lsystem1.setRule("X","FF");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
	var line = lineFunc;
...
var drawings__$SierpinskiTriangle_SierpinskiTriangle_$Impl_$ = {};
$hxClasses["drawings._SierpinskiTriangle.SierpinskiTriangle_Impl_"] = drawings__$SierpinskiTriangle_SierpinskiTriangle_$Impl_$;
drawings__$SierpinskiTriangle_SierpinskiTriangle_$Impl_$.__name__ = true;
drawings__$SierpinskiTriangle_SierpinskiTriangle_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "A"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("A","B-A-B");
...
var drawings__$Tiles_Tiles_$Impl_$ = {};
$hxClasses["drawings._Tiles.Tiles_Impl_"] = drawings__$Tiles_Tiles_$Impl_$;
drawings__$Tiles_Tiles_$Impl_$.__name__ = true;
drawings__$Tiles_Tiles_$Impl_$._new = function(iterations,distance,pos,lineFunc) {
	var this1;
	var options = { axiom : "[7]++[7]++[7]++[7]++[7]"};
	var lsystem1 = new lsystem_LSystem(options);
	lsystem1.setRule("6","81++91----71[-81----61]++");
	lsystem1.setRule("7","+81--91[---61--71]+");
	lsystem1.setRule("8","-61++71[+++81++91]-");
	lsystem1.setRule("9","--81++++61[+91++++71]--71");
	lsystem1.setRule("1","");
	lsystem1.iterate(iterations);
	var angle = 270.0;
	var d = distance;
...
$hxClasses["khaMath.Vector2"] = khaMath_Vector2;
...
var lsystem_LNode = function(pos_,angle_) {
	this.pos = pos_;
	this.angle = angle_;
};
$hxClasses["lsystem.LNode"] = lsystem_LNode;
lsystem_LNode.__name__ = true;
lsystem_LNode.prototype = {
	pos: null
	,angle: null
	,transform: function(distance) {
		var deg = this.angle * (Math.PI / 180.0);
		return new lsystem_LNode(new khaMath_Vector2(this.pos.x + Math.cos(deg) * distance,this.pos.y + Math.sin(deg) * distance),this.angle);
	}
	,clone: function() {
		return new lsystem_LNode(new khaMath_Vector2(this.pos.x,this.pos.y),this.angle);
	}
	,addAngle: function(q) {
		this.angle += q;
	}
	...
	,__class__: lsystem_LNode
};
var lsystem_LSystem = function(options) {
	this.m_options = options;
	this.m_rules = new haxe_ds_StringMap();
	this.createStandardRules();
};
$hxClasses["lsystem.LSystem"] = lsystem_LSystem;
lsystem_LSystem.__name__ = true;
lsystem_LSystem.prototype = {
	m_options: null
	,get_options: function() {
		return this.m_options;
	}
	,set_options: function(_options) {
		return this.m_options = _options;
	}
	,m_rules: null
	,createStandardRules: function() {
		var _this = this.m_rules;
		if(__map_reserved["+"] != null) {
			_this.setReserved("+","+");
		} else {
			_this.h["+"] = "+";
		}
		var _this1 = this.m_rules;
		if(__map_reserved["-"] != null) {
			_this1.setReserved("-","-");
		} else {
			_this1.h["-"] = "-";
		}
		var _this2 = this.m_rules;
		if(__map_reserved["["] != null) {
			_this2.setReserved("[","[");
		} else {
			_this2.h["["] = "[";
		}
		var _this3 = this.m_rules;
		if(__map_reserved["]"] != null) {
			_this3.setReserved("]","]");
		} else {
			_this3.h["]"] = "]";
	...
	,iterate: function(i) {
		...
		while(currentIteration < i) {
			...
			while(_g < commands.length) {
				...
				++_g;
				newAxiom += this.parseCommand(command);
			}
	...
	,parseCommand: function(cmd) {
		var _this = this.m_rules;
		if(__map_reserved[cmd] != null ? _this.existsReserved(cmd) : _this.h.hasOwnProperty(cmd)) {
			var _this1 = this.m_rules;
			if(__map_reserved[cmd] != null) {
				return _this1.getReserved(cmd);
			} else {
				return _this1.h[cmd];
			}
		}
	...
	,setRule: function(axiom,rule) {
		var _this = this.m_rules;
		if(__map_reserved[axiom] != null) {
			_this.setReserved(axiom,rule);
		} else {
			_this.h[axiom] = rule;
		}
	}
	,__class__: lsystem_LSystem
};
var lsystem__$StateStack_StateStack_$Impl_$ = {};
$hxClasses["lsystem._StateStack.StateStack_Impl_"] = lsystem__$StateStack_StateStack_$Impl_$;
lsystem__$StateStack_StateStack_$Impl_$.__name__ = true;
lsystem__$StateStack_StateStack_$Impl_$._new = function(i) {
	var this1 = [];
	this1[0] = i;
	return this1;
};
lsystem__$StateStack_StateStack_$Impl_$.rotate = function(this1,q) {
	this1[this1.length - 1].addAngle(q);
};
lsystem__$StateStack_StateStack_$Impl_$.pushSame = function(this1) {
	var currentState = this1[this1.length - 1];
	this1[this1.length] = currentState.clone();
};
lsystem__$StateStack_StateStack_$Impl_$.forwardDraw = function(this1,distance) {
	var currentState = this1[this1.length - 1];
	var newState = currentState.transform(distance);
	this1[this1.length - 1] = newState;
	return new lsystem_TwoNodes(currentState,newState);
};
lsystem__$StateStack_StateStack_$Impl_$.forward = function(this1,distance) {
	var currentState = this1[this1.length - 1];
	var newState = currentState.transform(distance);
	this1[this1.length - 1] = newState;
};
var lsystem_TwoNodes = function(a_,b_) {
	this.start = a_;
	this.end = b_;
};
$hxClasses["lsystem.TwoNodes"] = lsystem_TwoNodes;
lsystem_TwoNodes.__name__ = true;
lsystem_TwoNodes.prototype = {
	start: null
	,end: null
	,__class__: lsystem_TwoNodes
};
var target__$BasicColors_BasicColors_$Impl_$ = {};
$hxClasses["target._BasicColors.BasicColors_Impl_"] = target__$BasicColors_BasicColors_$Impl_$;
target__$BasicColors_BasicColors_$Impl_$.__name__ = true;
target__$BasicColors_BasicColors_$Impl_$._new = function(col) {
	var this1 = col;
	return this1;
};
target__$BasicColors_BasicColors_$Impl_$.fromInt = function(i) {
	var bc = js_Boot.__cast(i , Int);
	return bc;
};
...
target__$BasicColors_BasicColors_$Impl_$.Green = (function($this) {
	var $r;
	var bc = js_Boot.__cast(-16711936 , Int);
	$r = bc;
	return $r;
}(this));
target__$BasicColors_BasicColors_$Impl_$.Blue = (function($this) {
	var $r;
	var bc = js_Boot.__cast(-16776961 , Int);
	$r = bc;
	return $r;
}(this));
target__$BasicColors_BasicColors_$Impl_$.Red = (function($this) {
	var $r;
	var bc = js_Boot.__cast(-65536 , Int);
	$r = bc;
	return $r;
}(this));
target__$BasicColors_BasicColors_$Impl_$.Yellow = (function($this) {
	var $r;
	var bc = js_Boot.__cast(-256 , Int);
	$r = bc;
	return $r;
}(this));
target__$BasicColors_BasicColors_$Impl_$.White = (function($this) {
	var $r;
	var bc = js_Boot.__cast(-1 , Int);
	$r = bc;
	return $r;
}(this));
target__$BasicColors_BasicColors_$Impl_$.Grey = (function($this) {
	var $r;
	var bc = js_Boot.__cast(-3355444 , Int);
	$r = bc;
	return $r;
}(this));
Main.main();
