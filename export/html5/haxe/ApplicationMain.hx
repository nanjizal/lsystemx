...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("lsystemxAnimation", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("lsystemxAnimation", null, 1024, 765);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "lsystemxAnimation";
		app.meta["name"] = "lsystemxAnimation";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("lsystemx.demoUse.FlixelUse")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess lsystemx.demoUse.FlixelUse.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"lsystemx.demoUse.FlixelUse\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"lsystemx.demoUse.FlixelUse\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends lsystemx.demoUse.FlixelUse {}
#else
class DocumentClass
{
